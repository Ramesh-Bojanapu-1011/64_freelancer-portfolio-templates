...
const Branding = () => {
  ...
  const whyItems = t("branding.whyFeatures.items", { returnObjects: true }) as
    | Array<{ title: string; desc: string }>
    | undefined;
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={t("branding.metaDescription")} />
              ...
              {(processSteps || []).map((step, idx, arr) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-4 text-xl font-bold text-cyan-700 dark:text-yellow-300 mb-2 text-center   text-nowrap">
                      {step.title}
                    </h3>
                    <p className="text-blue-800 dark:text-blue-200 text-base mb-2 text-center  ">
                      {step.desc}
                    </p>
                    {idx < arr.length - 1 && (
                      <span
